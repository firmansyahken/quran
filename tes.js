...
//   // Mendapatkan teks dari objek JSON
//   const texts = data.text;
  
//   // Menampilkan teks menggunakan nomor sebagai kunci
//   Object.keys(texts).forEach(key => {
//     console.log(`${texts[key]}`);
//   });
  

// import Detail from "./src/assets/data/1.json" assert { type: "json" };

// Object.keys(Detail["1"].text).forEach(key => {
//     console.log(`${Detail["1"].text[key]}`);
// });